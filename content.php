...
<section>
  <form>
    ...
    <label><img class="DieLabel" src="<?php echo $contentPath ?>/icons/32x32-d12.png" title="d12" /> <input type="number" id="d12" class="die" data-size="12" max="99" min="0" size="2"/></label>
    <label><img class="DieLabel" src="<?php echo $contentPath ?>/icons/32x32-d10.png" title="d10" /> <input type="number" id="d10" class="die" data-size="10" max="99" min="0" size="2"/></label>
    <br />
    <label><img class="DieLabel" src="<?php echo $contentPath ?>/icons/32x32-d8.png" title="d8" /> <input type="number" id="d8" class="die" data-size="8" max="99" min="0" size="2"/></label>
    <label><img class="DieLabel" src="<?php echo $contentPath ?>/icons/32x32-d6.png" title="d6" /> <input type="number" id="d6" class="die" data-size="6" max="99" min="0" size="2"/></label>
    <label><img class="DieLabel" src="<?php echo $contentPath ?>/icons/32x32-d4.png" title="d4" /> <input type="number" id="d4" class="die" data-size="4" max="99" min="0" size="2"/></label>
    <br />
